    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>krishnabansal583@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>
            Ajay Kumar Garg Engineering College, 27th K.M Stone, NH—24, Delhi
            Hapur Bypass Road, Adhyatmik Nagar, Ghaziabad, Uttar Pradesh 201009
          </span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>+91-8650156202</span>
        </motion.div>
      </motion.div>
